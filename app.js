...
Ext.onReady(function () {
    ...
    var userStore = new Kanban.data.ResourceStore({
        ...
        data : [
            { Id : 1, Name : 'Mats', ImageUrl : '/taskboard-0.001-trial/images/mats.jpeg' },
            { Id : 2, Name : 'Homer', ImageUrl : '/taskboard-0.001-trial/images/homer.jpg' },
            { Id : 3, Name : 'Brian', ImageUrl : '/taskboard-0.001-trial/images/brian.jpeg'},
            { Id : 8, Name : 'That guy', ImageUrl : '/taskboard-0.001-trial/images/unknown.gif'}
        ]
    });
