    ...
    t.it('Combo field', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(recorderEvents[0].type, 'click');
                t.is(recorderEvents[0].actionTarget, '#form-widgets combobox[my=combo] => .x-form-text');

                t.is(recorderEvents[1].type, 'click');
                t.is(recorderEvents[1].actionTarget, '#form-widgets combobox[my=combo] => .x-form-trigger');

                t.is(recorderEvents[2].type, 'click');
                t.is(recorderEvents[2].actionTarget, /*#form-widgets */'combobox[my=combo].getPicker() => .x-boundlist-item:contains(Bar)');
            }
        )
    })
        ...
        t.requireOk('Ext.ux.ajax.SimManager', function () {
            ...
            t.chain(
                ...
                function () {
                    ...
                    t.is(recorderEvents.length, 3);
                    t.is(recorderEvents[0].type, 'click');
                    t.is(recorderEvents[0].actionTarget, '#form-widgets combobox[my=combo2] => .x-form-text');

                    t.is(recorderEvents[1].type, 'click');
                    t.is(recorderEvents[1].actionTarget, '#form-widgets combobox[my=combo2] => .x-form-trigger');

                    t.is(recorderEvents[2].type, 'click');
                    t.is(recorderEvents[2].actionTarget, /*#form-widgets */'combobox[my=combo2].getPicker() => .x-boundlist-item:contains(user2)');
                }
            )
        })
    })
