...
</span> * Low level class which records the events of the window it's attached to. It records basic mouse and key events,
...
<span id='global-event-eventrecorded'>                    /**
</span>                     * @event eventrecorded
