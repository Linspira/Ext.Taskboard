...
</span>         * Utility method which checks if the passed method is the 'top' element at its position. &quot;Top&quot; element means,
...
</span>         * This method is a wrapper around the {@link #chainClick}, it performs a click on the every element found with the DOM query.
         * 
