...
</span>         * This assertion passes, when the `func` function throws the exception during executing, and the
...
<span id='Siesta-Test-More-method-waitFor'>        /**
    ...
    t.waitFor({
        ...
        waitFor : function (method, callback, scope, timeout, interval)  {
            ...
            var description             = isWaitingForTime ? (method + ' ' + R.get('ms')) : description;
            var me                      = this;
