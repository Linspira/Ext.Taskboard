...
<span id='Siesta-Harness-Browser-cfg-debuggerOnFail'>            /**
</span>             * @cfg {Boolean} debuggerOnFail When set to `true`, harness will issue a `debugger` statement after detecting a failed assertion, allowing you
...
<span id='Siesta-Harness-Browser-cfg-autoScrollElementsIntoView'>            /**
</span>             * @cfg {Boolean} autoScrollElementsIntoView
             * 
