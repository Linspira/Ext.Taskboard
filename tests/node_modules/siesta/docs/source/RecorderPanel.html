...
*/
<span id='Siesta-Recorder-RecorderPanel'>/**
</span> * The UI class containing an EventView .
 */
...
<span id='Siesta-Recorder-RecorderPanel-property-layout'>    layout      : 'fit',
</span><span id='Siesta-Recorder-RecorderPanel-property-buttonAlign'>    buttonAlign : 'left',
</span><span id='Siesta-Recorder-RecorderPanel-property-border'>    border      : false,
</span>
<span id='Siesta-Recorder-RecorderPanel-property-newEventDefaults'>    newEventDefaults : {
</span>        type : 'click'
    },

<span id='Siesta-Recorder-RecorderPanel-property-test'>    test         : null,
</span><span id='Siesta-Recorder-RecorderPanel-property-recorder'>    recorder     : null,
</span><span id='Siesta-Recorder-RecorderPanel-property-bodyBorder'>    bodyBorder   : false,
</span><span id='Siesta-Recorder-RecorderPanel-property-harness'>    harness      : null,
</span><span id='Siesta-Recorder-RecorderPanel-property-domContainer'>    domContainer : null,
</span>
<span id='Siesta-Recorder-RecorderPanel-property-extractorClass'>    extractorClass       : Siesta.Recorder.TargetExtractor.ExtJS,
</span><span id='Siesta-Recorder-RecorderPanel-property-extractorClassConfig'>    extractorClassConfig : null,
</span>
<span id='Siesta-Recorder-RecorderPanel-method-resolveTarget'>    // ActionTarget to DOM el, used to highlight the active element
</span>    resolveTarget        : function (target) {
        try {
...
<span id='Siesta-Recorder-RecorderPanel-method-hideHighlighter'>    hideHighlighter : function () {
</span>        if (this.test) {
            this.domContainer.clearHighlight();
        }
    },

<span id='Siesta-Recorder-RecorderPanel-method-highlightTarget'>    highlightTarget : function (target) {
</span>        var test = this.test;
        var warning;
...
<span id='Siesta-Recorder-RecorderPanel-method-initComponent'>    initComponent : function () {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-event-startrecord'>            /**
...
<span id='Siesta-Recorder-RecorderPanel-event-stoprecord'>            /**
...
<span id='Siesta-Recorder-RecorderPanel-method-createToolbars'>    createToolbars : function () {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-attachTo'>    // Attach to a test (and optionally a specific iframe, only used for testing)
</span>    attachTo       : function (test, iframe) {
        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-getEventView'>    getEventView : function () {
</span>        if (!this.eventView) {
...
<span id='Siesta-Recorder-RecorderPanel-method-onRecordClick'>    onRecordClick : function () {
</span>        var test = this.test;
...
<span id='Siesta-Recorder-RecorderPanel-method-onPlayClick'>    onPlayClick : function () {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-stop'>    stop : function () {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-closeRecorder'>    closeRecorder : function () {
</span>        this.stopRecorder();
    },

<span id='Siesta-Recorder-RecorderPanel-method-clear'>    clear : function () {
</span>        if (this.recorder) {
            this.recorder.clear();
        }
        this.store.removeAll();
    },

<span id='Siesta-Recorder-RecorderPanel-method-setTest'>    setTest : function(test) {
</span>        this.test = test;

        this.eventView.test = test;
    },

<span id='Siesta-Recorder-RecorderPanel-method-generateSteps'>    generateSteps : function (events) {
</span>        var steps = [];
...
<span id='Siesta-Recorder-RecorderPanel-method-eventToStep'>    eventToStep : function (event) {
</span>        var data = event.data;
...
<span id='Siesta-Recorder-RecorderPanel-method-onEventRecorded'>    onEventRecorded : function (e, recorder, recordedEvent) {
</span>        recordedEvent.index = this.store.getCount();
...
<span id='Siesta-Recorder-RecorderPanel-method-onMouseEventCoalese'>    onMouseEventCoalese : function (e, recorder, event) {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-generateCodeForSteps'>    generateCodeForSteps : function () {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-objectToSource'>    objectToSource : function (obj) {
</span>        var me = this;
...
<span id='Siesta-Recorder-RecorderPanel-method-onDestroy'>    onDestroy : function () {
</span>        this.recorder.stop();
